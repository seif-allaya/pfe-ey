...
def cvss3(data)
  ...
  if cvss_total == 0
  data["risk_cvss_v3"]="None"
  data["risk"]=0

  elsif (cvss_total >= 0.1 and cvss_total <= 3.9)
  data["risk_cvss_v3"]="Low"
  data["risk"]=1

  elsif (cvss_total >= 4.0 and cvss_total <= 6.9)
  data["risk_cvss_v3"]="Medium"
  data["risk"]=2

  elsif (cvss_total >= 7.0 and cvss_total <= 8.9)
  data["risk_cvss_v3"]="High"
  data["risk"]=3

  else
  data["risk_cvss_v3"]="Critical"
  data["risk"]=4
  end
